...
def show():
    ...
    - **[Datasets](https://github.com/aymanggv/data-warehouse-project/tree/main/datasets):** Access to the project dataset (CSV files).
    ...
    - **[Git Repository](https://github.com/aymanggv):** A GitHub account and repository to manage, version, and collaborate on the code efficiently.
